        ...
        <div className="">
            ...
            <nav className={nav ? 'block absolute right-0 top-0 bg-gray-900 h-auto' : "p-4 w-20 hidden lg:block md:block"}>
                <ul className="border-none md:rounded-full lg:rounded-full md:bg-gray-900 lg:bg-gray-900 w-auto md:w-12 lg:w-12 p-4 pb-4 md:p-4 lg:p-4 justify-evenly text-white font-bold md:mt-4 lg:mt-4">
                    <li>
                        <Link href='/' className='flex md:block lg:block hover:text-gray-500 transition-all'>
                    ...
                    <li className="mt-4">
                        <Link href='/collections' className='flex md:block lg:block  hover:text-gray-500 transition-all'>
                            <IconContext.Provider value={{ color: 'yellow' }}>
                ...
                <li className="">
                    <Link href='/account' className='flex md:block lg:block  hover:text-gray-500 transition-all '>
                            <IconContext.Provider value={{ color: 'yellow' }}>
